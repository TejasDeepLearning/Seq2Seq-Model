...
# load in the data 
t = 0
for line in open(r"C:\Users\tejas\Documents\Datasets\Neural Machine Translation\spa-eng\spa.txt", encoding='utf-8'):
    t += 1
    if t > NUM_SAMPLES:
        break 
...
print(f'num_samples: {len(input_texts)}')
...
# don't filter out special characters otherwise <sos> and <eos> won't appear
...
word2vec = {}
with open(os.path.join(rf"C:\Users\tejas\Documents\Datasets\glove.6B\glove.6B.{EMBEDDING_DIM}d.txt"), encoding='utf-8') as f:
